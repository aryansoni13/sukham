        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'About Us', 'Rooms', 'Career', 'Contact Us'].map((link) => (
                <li key={link}>
                  <a href={`#${link.toLowerCase().replace(' ', '-')}`} className="hover:text-primary transition-colors">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Bonfire', 'Trekking', 'Site Seeing', 'Swimming'].map((activity) => (
                <li key={activity}>
                  <a href={`#${activity.toLowerCase().replace(' ', '-')}`} className="hover:text-primary transition-colors">
                    {activity}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p>1/350C, Irupukal, Opposite Pandian Park, Kotagiri, Nilgiri District, 643217</p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:sukhamresort@gmail.com" className="hover:text-primary transition-colors">
          ...
          <div>
            <h3 className="text-white font-serif text-2xl mb-4">SUKHAM RESORT</h3>
            <p className="text-gray-400 mb-6">Experience luxury and tranquility in the heart of Nilgiri District.</p>
