      ...
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full relative animate-[slideIn_0.3s_ease-out]">
        ...
        <div className="p-6">
          <div className="bg-primary/10 rounded-lg p-4 mb-4">
            <h2 className="text-2xl font-serif text-primary text-center mb-2">SUKHAM RESORT, Kotagiri</h2>
          ...
          <div className="border-t border-gray-100 pt-4">
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="flex items-center gap-2 text-gray-700">
                <div className="text-primary"><Flame className="w-4 h-4" /></div>
                <span className="text-sm">Bonfire(Paid)</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <div className="text-primary"><Car className="w-4 h-4" /></div>
                <span className="text-sm">Free Parking</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <div className="text-primary"><Camera className="w-4 h-4" /></div>
                <span className="text-sm">CCTV Surveillance</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <div className="text-primary"><Utensils className="w-4 h-4" /></div>
            ...
            <div className="bg-gray-50 rounded p-4 text-center mb-4">
              ...
              <p className="text-gray-700 text-sm">Food Options: In-house | Pack Your Own | Zomato</p>
            </div>
            ...
            <div className="text-center space-y-2">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <a href="tel:9445842201" className="text-primary hover:underline">9445842201</a>
                <span className="text-gray-400">|</span>
                <a href="tel:9047475131" className="text-primary hover:underline">9047475131</a>
              </div>
